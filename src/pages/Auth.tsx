  ...
  return (
    <div 
      ...
      style={{
        ...
        backgroundColor: theme === 'dark' && !settings.login_bg_url ? '#09090b' : (settings.login_bg_color || '#f3f4f6'),
    ...
    >
      ...
      <Card className={`w-full max-w-md shadow-lg ${theme === 'dark' ? 'bg-zinc-900 border-zinc-800' : 'bg-white border-gray-100'}`}>
